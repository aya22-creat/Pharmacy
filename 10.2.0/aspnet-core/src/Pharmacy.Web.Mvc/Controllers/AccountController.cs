...
using Pharmacy.Sessions;
using Pharmacy.Web.Models.Account;
using Pharmacy.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : PharmacyControllerBase
{
