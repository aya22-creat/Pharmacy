...
public abstract class PharmacyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static PharmacyWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(PharmacyWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<PharmacyDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<PharmacyDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<PharmacyDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<PharmacyDbContext, Task<T>> func)
    {
        T result;
